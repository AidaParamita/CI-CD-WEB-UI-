...
WebUI.setText(findTestObject('Object Repository/Homepage/Buy_Items/Page_frontend-web/input_Email_input-18'), 'olaf@gmail.com')

WebUI.setText(findTestObject('Object Repository/Homepage/Buy_Items/Page_frontend-web/input_Password_input-21'), 'olafaja')

WebUI.click(findTestObject('Object Repository/Homepage/Buy_Items/Page_frontend-web/button_Login'))
